...
s3_path_input = f"s3://{source_bucket_name}/{file_name}" + ".txt"
# s3_path_input = f"s3://{crawler_bucket_name}/input/data0.txt"
...
if latest_file:
    destination_key = f"textdata/transformed_{file_name}.txt"
